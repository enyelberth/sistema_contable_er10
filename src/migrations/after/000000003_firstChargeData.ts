...
('01',upper('Inventario Inicial'),'I'),
('02', upper('Incorporacion por Traspaso'),'I'),
('03',upper('Compras'),'I'),
('04',upper('Construccion de inmuebles'),'I'),
('05',upper('Adiciones y Mejoras'),'I'),
('06',upper('Produccion de elementos (Muebles)'),'I'),
('07',upper('Suministro de bienes de otras entidades'),'I'),
('08',upper('Devolucion de bienes suministrados a contratistas'),'I'),
('09',upper('Nacimiento de Semovientes'),'I'),
